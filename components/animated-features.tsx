...
const features = [
  {
    ...
    icon: Database,
    animation: "https://lottie.host/embed/a4d2c8f1-7b3e-4c9a-8d5f-1e2a3b4c5d6e/abcdefghij.json",
  },
  {
    name: "AI 智慧營運",
    description: "將生成式 AI 與機器學習模型導入企業核心流程，升級數據分析、營運決策及顧客服務。",
    icon: Bot,
    animation: "https://lottie.host/embed/b5e3d9g2-8c4f-5d0b-9e6g-2f3a4b5c6d7e/klmnopqrst.json",
  },
  {
    name: "Shopify OMO 智慧電商整合",
    description: "協助品牌快速搭建線上+線下全通路數位生態，串接門市、電商、社群及會員數據。",
    icon: ShoppingCart,
    animation: "https://lottie.host/embed/c6f4e0h3-9d5g-6e1c-0f7h-3g4b5c6d7e8f/uvwxyzabcd.json",
  },
  {
    name: "客製化專案",
    description: "針對製造、醫療、教育、政府等具複雜流程的產業，提供完整的客製化解決方案。",
    icon: Settings,
    animation: "https://lottie.host/embed/d7g5f1i4-0e6h-7f2d-1g8i-4h5c6d7e8f9g/efghijklmn.json",
  },
]
        ...
        {features.map((feature) => (
          ...
          >
            ...
            <div className="absolute top-4 right-4 opacity-20 group-hover:opacity-40 transition-opacity duration-300">
              <LottieAnimation src={feature.animation} className="w-16 h-16" loop={true} autoplay={false} speed={0.5} />
            </div>
